---
title: "Frontal Activation in Multiple Subjects"
author: "He Junhui"
date: "`r Sys.Date()`"
...
ms = c(500,1000,2000,4000) # number of labeled samples
a = 0.01
res_list = lapply(c(1:(length(ms)*3)), function(i) {return(matrix(NA,nrow=4,ncol=num_exps))})
```
...
write.csv(res_table, paste0("tables/hcp/act/",subject,".csv"))
...
# Time difference of 9.724742 hours
```
